...
| Primary market(s) | GCC markets — KSA, Bahrain, and others. **Confirm exactly which countries.** |
...
Unconfirmed starting point: likely EN + AR (Arabic is RTL). Confirm per market.
...
- **Vertical(s):** General classifieds (motors, property, jobs, goods, services).
...
**Note for whoever fills this in:** Multi-market classifieds app. Confirm which countries, whether vocabulary/verticals vary by market, and how markets are routed. Classifieds vocabulary, not property.
