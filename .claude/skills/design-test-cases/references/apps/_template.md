...
- **Vertical(s):** TODO — property, motors, general classifieds, jobs, etc.
...
- **Anything structurally unusual:** TODO — multi-vertical routing, a marketplace-within-a-marketplace, an auction model, etc.
